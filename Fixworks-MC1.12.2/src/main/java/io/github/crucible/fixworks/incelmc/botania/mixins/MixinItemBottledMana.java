package io.github.crucible.fixworks.incelmc.botania.mixins;
...
public abstract class MixinItemBottledMana {
    ...
    @Shadow
    protected abstract void randomEffect(EntityLivingBase player, ItemStack stack);

    @Shadow
    protected abstract long randomSeed(ItemStack stack);
