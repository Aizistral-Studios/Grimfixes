package io.github.crucible.fixworks.chadmc.betterfurnace.mixins;
...
public abstract class MixinTileEntityBetterFurnace implements ISidedInventory {
    ...
    @Shadow
    public abstract ItemStack getUpgrade(Item upgrade);

    @Shadow
    public abstract byte getAbsoluteSide(byte relative, byte standart);
