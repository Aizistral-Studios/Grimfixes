package io.github.crucible.fixworks.chadmc.enderio.implementation;
...
public class PaintingMachineSlot extends Slot {
    ...
    public static class INPUT extends PaintingMachineSlot {
        ...
        @Override
        public boolean isItemValid(ItemStack itemStack) {
            return !itemStack.hasTagCompound() && this.machineContainer.getInv().isItemValidForSlot(this.getSlotIndex(), itemStack);
        }
    }
}
