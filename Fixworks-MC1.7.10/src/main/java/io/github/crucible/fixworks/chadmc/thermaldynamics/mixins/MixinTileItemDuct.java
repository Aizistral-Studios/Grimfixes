package io.github.crucible.fixworks.chadmc.thermaldynamics.mixins;
...
public abstract class MixinTileItemDuct implements IMultiBlockRoute {
    ...
    @Shadow
    public abstract RouteCache getCache();
    ...
    public Route getRoute(IMultiBlockRoute itemDuct) {
        ...
        RouteCache routeCache = this.getCache();
    ...
    public RouteCache getCache(boolean urgent) {
        return this.internalGrid == null ? null : //Add null check to prevent NPE
            urgent ? this.internalGrid.getRoutesFromOutput(this) : this.internalGrid.getRoutesFromOutputNonUrgent(this);
    }
}
